  ...
  return (
    ...
    >
      ...
      <span
        ...
        style={{
          backgroundImage:
            'url("https://sxcontent9668.azureedge.us/cms-assets/assets/Kuiper_KF_01_outsidesouthgrassh_DSC_3461_desktop_ea033c599b.jpg")',
        }}
      ></span>
      {/* Overlay */}
      ...
      >
        ...
        <a
          ...
          tabIndex={0}
          href="#"
          aria-label="REWATCH KF-01 MISSION"
          role="button"
        >
          <span
            className="
