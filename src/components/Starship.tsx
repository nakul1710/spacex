  ...
  return (
    ...
    >
      ...
      <span
        ...
        style={{
          backgroundImage:
            'url("https://sxcontent9668.azureedge.us/cms-assets/assets/Flight_9_Website_Desktop_4_f1db4d08ec.jpg")',
        }}
      ></span>
      {/* Overlay */}
      ...
      >
        ...
        <a
          ...
          "
          tabIndex={0}
          href="/launches/mission/?missionId=starship-flight-9"
          aria-label="REWATCH Starship's Ninth Flight Test"
          role="button"
        >
          <span
            className="
